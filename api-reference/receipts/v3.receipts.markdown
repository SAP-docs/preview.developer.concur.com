...
<div class="alert alert-danger">
  ...
  <p>[Receipts v4](./get-started.html) which replaces this API opens doors to global availability, enriched schemas, and better support for detailed tax content.</p>
...
## Create a new receipt <a name="post"></a>
