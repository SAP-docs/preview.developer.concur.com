...
---|---|---
[01/2024](https://developer.concur.com/tools-support/release-notes/api/2024-01-11.html)|Hotel Service|Updates to Hotel Service v4 that will remove existing elements from the <Profiles> section relating to gender and name prefixes.
