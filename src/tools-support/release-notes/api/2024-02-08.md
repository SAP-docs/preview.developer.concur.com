...
Two changes to the Cash Advance feature will be available in an upcoming release. These changes apply to clients using the Cash Advance feature in combination with either the Financial Integration Services (FIS) API with client web services or SAP ICS.
