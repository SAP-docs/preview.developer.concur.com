...
---|---|---
[06/2024](/tools-support/release-notes/api/2024-06-06.html)|Report Short URL|The PATCH endpoint will allow companies to edit certain report-level attributes on expense reports prior to extraction. Editable attributes will include custom fields/org units, business purpose, comment and report name.
