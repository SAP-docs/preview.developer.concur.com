...
### Preview: SSL Certificates Renewal
SAP Concur plans to renew the certificates for `*.concursolutions.com` and `*api.concursolutions.com` in May 2026.

Due to industry-wide changes implemented by our Certificate Authority, DigiCert, the maximum validity period for publicly trusted TLS certificates has been reduced to 199 days. As a result, SAP Concur's certificates will now be renewed more frequently than in previous years.
...
> Note: This change is part of broader security improvements across the industry.
> There is no impact to the security, availability, or trust of SAP Concur's services.
...
You can follow the steps below to test the certificates in staging:

DNS Name | Staging Name
----------|--------------
us2.concursolutions.com|e7833.dsca.akamaiedge-staging.net
eu2.concursolutions.com|e7833.dsca.akamaiedge-staging.net
apj1.concursolutions.com|e7833.dsca.akamaiedge-staging.net
www.concursolutions.com|e7833.dsca.akamaiedge-staging.net
us2.api.concursolutions.com|e13151.dscb.akamaiedge-staging.net
eu2.api.concursolutions.com|e13151.dscb.akamaiedge-staging.net
apj1.api.concursolutions.com|e13151.dscb.akamaiedge-staging.net

1. Do nslookup of the staging name. You will find the DNS name and Staging name from the table above. To test www.concursolutions.com you should use the staging name e7833.dsca.akamaiedge-staging.net sample below:

```
nslookup e7833.dsca.akamaiedge-staging.net

Server: 2405:b800:fef:ff00::2

Address: 2405:b800:fef:ff00::2#53

Non-authoritative answer:

Name: e7833.dsca.akamaiedge-staging.net

Address: 104.71.66.26
```

2. Get the resulting IP 104.71.66.26 and add it to your host file

**MAC users**
MAC users should follow the steps below to test the certificate:
1. Open terminal.

2. Type `sudo nano /private/etc/hosts`.

> Note: Make sure you have requested **Privilege**.

3. Add the line below in your host file: Please use the nslookup IP you had.

`104.71.66.26 www.concursolutions.com`

4. CTRL+X then Y for Yes to save the changes.

**Windows users**
Windows users should follow the steps below to test the certificate:
1. Open your notepad as an administrator.

2. Open the host file and follow the steps below:
...
3. Add below line on your host file: Please use the nslookup IP you had from an earlier step.

`104.71.66.26 www.concursolutions.com`

4. Save.

You should now see the updated certificates with new root and new certificate expiry.
