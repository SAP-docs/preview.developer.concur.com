...
[12/2022](/tools-support/release-notes/api/2022-12-02.html)|Deprecation and Decommission of Vendor v3|Once Vendors v3.1 is released, users will have sixty days to migrate to the latest version of the API.
