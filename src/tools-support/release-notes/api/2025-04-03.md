...
### Preview: Admin Attendee Types v4 API

The Attendee Service API suite will be updated to include APIs to retrieve all admin attendee types.
...
The Malay and Slovenian languages have been added to the supported locales. 
