...
The Malay and Slovenian languages will be added to the supported locales. To see the complete list of all the available locale codes, go to [Locale Codes](https://developer.concur.com/api-reference/locale-codes.html). 
