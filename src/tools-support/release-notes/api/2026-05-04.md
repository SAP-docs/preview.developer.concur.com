---
title: SAP Concur Developer Center - API Release Notes, May 2026
layout: reference
---
# API Release Notes, May 2026

## New This Month

### Now Available: ESS Customer Workflow Improvement

**Overview**

The Event Subscription Service no longer requires company and application connection setup for single-customer use cases. For applications with `AllowedPrincipals` configured to a specific company UUID (instead of *), the company UUID will be automatically populated into the subscription Company ID list, eliminating the need to generate a Request Token as an additional step. This change does not impact partner-type integrations.

This enhancement simplifies customer integration by removing an unnecessary configuration step for single-customer scenarios.

**Configuration / Feature Activation**

Please consult your IT department to determine whether this change applies to your integration setup.

### Preview: Legal Entity v4.1

The Legal Entity v4.1 API will allow customers and partners to manage legal entity profiles within their company structure using SCIM standards. New public endpoints will support creating, retrieving, updating, replacing, and searching legal entities, with authentication via Bearer token and company context provided through JWT or companyId query parameter.


### Now Available: Manage Participants of an Existing Request in Request v4
