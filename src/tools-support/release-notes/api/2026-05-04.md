...
The Legal Entity API v4.1 will allow customers and partners to manage legal entity profiles within their company structure using SCIM standards. New public endpoints will support creating, retrieving, updating, replacing, and searching legal entities, with authentication via Bearer token and company context provided through JWT or companyId query parameter.
