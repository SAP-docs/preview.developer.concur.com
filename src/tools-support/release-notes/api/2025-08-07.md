...
### Important: POST Behavior Change in Attendee V4

During a POST operation, even if a single attendee matches the duplicate criteria, a duplicate error will be thrown.
