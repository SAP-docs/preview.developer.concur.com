...
We have released a 4.1 version of our [spend user extension](https://developer.concur.com/api-reference/user-provisioning/spend/v4.1.spend-user-retrieval.html) to retrieve spend profile data. This release is to meet standard software attribute naming protocols for `orgUnitX` attributes.  There is no change in functionality of the spend user extension.

### ### Deprecation of Spend User Retrieval 4.0

Effective March 14, 2024, the Spend User Extension 4.0 API has been deprecated. This has been replaced by [spend user extension](https://developer.concur.com/api-reference/user-provisioning/spend/v4.1.spend-user-retrieval.html). Decommission will follow in April 2025.
