...
A new fields have been added to the Financial Integration Services (FIS) v4 API. `merchantTaxId` provides additional tax information for expense reports.
...
For new users willing to take benefits of the Concur Request External Validation Workflow Feature, please work with your Concur representative to rely on the Concur Event Subscription Service and configure the Concur Request Workflow accordingly.
...
For more information about the Agency Proposals feature certification for travel agencies, refer to the Agency Proposal (API) Information section in this guide.
...
[04/2023](/tools-support/release-notes/api/2023-04-07.html)|List Item Bulk v4 API|The List Item Bulk v4 API allows for creating and modifying multiple list items in a list. The currently published List Item v4 API provides functionality for creating, updating, and deleting a single list item. 
