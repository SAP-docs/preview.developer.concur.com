...
SSL certificate renewals are scheduled as follows: 

* **US2, EU2, APJ1: `*.concursolutions.com`**
...
* **Concur Cloud for Public Sector: `usg.concursolutions.com` and `usg.api.concursolutions.com`**
