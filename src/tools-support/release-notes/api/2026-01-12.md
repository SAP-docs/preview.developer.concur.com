...
layout: reference
---
# API Release Notes, January 2026

## New This Month

### Preview: Groundspan Trip Extras
The Trip Extras will offer travelers ground transportation booking options through a redirect to Groundspan.This feature will replace the legacy Groundspan Direct Connect. 

**Terms and Conditions and Data Consumption**
This redirect will require the sharing of the following information.
![Groundspan Terms and Conditions](../../../api-guides/images/groundspan-trip-extras-terms_and_conditions.png)

This will take place by consuming the following APIs:

|Name                            |Link                                                                                          |
|--------------------------------|----------------------------------------------------------------------------------------------|
| Event Subscription Service v4  | https://developer.concur.com/api-reference/ess/v4.event-subscription.html                    |
| Concur Travel Booking Events   | https://preview.developer.concur.com/event-topics/travel/v4.travel-book-events.html          |
| Identity Change Event          | https://developer.concur.com/event-topics/profile/v4.identity-events.html                    |
| Identity v4                    | https://developer.concur.com/api-reference/profile/v4.identity.htm                           |
| Travel Extension v4            | https://developer.concur.com/api-reference/user-provisioning/travel/v4.travel-extension.html |
| Travel Profile v2              | https://developer.concur.com/api-reference/travel-profile/v2.profile-resource.html           |
| Receipts v4                    | https://developer.concur.com/api-reference/receipts/get-started.html                         |
| Maestro v4                     | https://preview.developer.concur.com/api-reference/common/maestro/v4.maestro.html            |
| Trip-extras                    | https://preview.developer.concur.com/api-reference/travel/itinerary/trip/trip-extras.html    |



### Preview: Additions to Reservation and Search Requests in Hotel Service v4

**New Travel Arranger Details**

The Hotel Service v4 API will add travel arranger details to a reservation request. When a booking is created by a travel arranger, the SAP Concur system will send the contact information for the arranger, in addition to the contact details of the traveler, in the Reservation request. This will allow hotel connectors to send a confirmation email to the travel arranger when required.

* Example of the Reservation Request Details:
...
**Addition of GIATA ID to Hotel Search Request**

When a traveler searches for a specific hotel, Concur Travel will send the GIATA ID of that hotel property in the Search request which will allow hotel connectors to easily identify the hotel being requested.

* Example of the New Element Details:

![GIATA ID example](./2026-01-12-hotel-service.png)
...
### Now Available: Endpoints for Admin Regions and Subdivisions in Localities v5

The Localities Service API suite has been enhanced to include a new set of v5 public GET APIs to retrieve data related to administrative regions and subdivisions, acting as a single source of truth for location-related information. They will provide similar coverage to the previous v3 and v4 APIs, which will be deprecated going ahead.
 
**Overview** 

The Localities Service has released three new GET API operations, as follows:
...
Data Center|Implementation Date
---|---
APJ1|November 13
EU2|November 19
US2|January 13, 2026
