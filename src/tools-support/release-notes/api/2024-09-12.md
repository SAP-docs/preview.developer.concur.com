...
[08/2024](/tools-support/release-notes/api/2024-08-08.html)|GET Payment Types v4 API|In September the Expense Configuration Service will release a new v4 GET Payment Types operation allowing retrieval of all policies applicable to a user based on their `userId`.
[08/2024](/tools-support/release-notes/api/2024-08-08.html)|GET Expense Types v4 API|In September the Expense Configuration Service will release a new v4 GET Expense Types operation allowing retrieval of all policies applicable to a user based on their `userId`.
