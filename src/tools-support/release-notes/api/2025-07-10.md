...
The SAP Concur platform will support IPv6 for network communication to and from SAP Concur solutions. This implementation is expected for Q3/2025. Previously, IPv6 was only supported for inbound HTTPS calls, and all other inbound and outbound calls supported only IPv4. 
