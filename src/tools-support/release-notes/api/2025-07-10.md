...
The `highlightedRateText` field has been added to the Rate Response model for the `/hotels/rates` endpoint in the Hotel Service v4 API. This is an optional field and of type `string`.
