...
The Expense v4 APIs are available for users of Expense for Professional and Standard Editions. Additional information, please see the Request v4 API documentation.
