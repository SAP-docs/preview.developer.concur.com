...
### Now Available: Localities v5 APIs

The Localities Service suite includes a new set of v5 public GET APIs to retrieve data related to countries, locations and subdivisions, acting as a single source of truth for location-related information. They provide similar coverage as the previous v3 and v4 API versions, which shall be deprecated going ahead.

**Overview**

The Localities Service releases five GET API operations, as follows:

* GET Countries v5 API

Allows you to retrieve all countries list along with currency codes.

* GET Country by Code v5 API

Allows you to retrieve a country details using a country code.

* GET Locations v5 API

Allows you to retrieve details of a locality given a legacy Location Name Key/Locality Code/Location Name Id or matching the given search text for a given company.

* GET Location by Locality Id v5 API

Allows you to retrieve location details given a Locality Id for a given company.

* GET Subdivisions v5 API

Allows you to retrieve list of subdivisions using a country code.
