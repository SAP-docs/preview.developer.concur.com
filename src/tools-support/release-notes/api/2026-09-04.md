...
### Deprecation of Latest Bookings

Effective September 14, 2026, the Latest Bookings API is deprecated. Decommission will follow.

### Deprecation of Opportunities

Effective September 14, 2026, the Opportunities API is deprecated. Decommission will follow.
...
---|---|---
`*.api.concursolutions.com`|November 10, 2026 at 10PM PDT|US2, EU2, APJ1
...
* RSA: [DigiCert TLS RSA4096 Root G5](https://cacerts.digicert.com/DigiCertTLSRSA4096RootG5.crt.pem)
* ECC/ECDSA: [DigiCert TLS ECC P384 Root G5](https://cacerts.digicert.com/DigiCertTLSECCP384RootG5.crt.pem)

For full details, including certificate download links and feature activation, refer to the Concur Shared Release Notes: [SSL Certificates Renewal for `*.api.concursolutions.com`](https://help.sap.com/docs/sap-concur/concur-shared-release-notes/preview-ssl-certificates-renewal-api-concursolutions-com).
