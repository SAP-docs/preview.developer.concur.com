...
`status`|[`ReservationStatus`](#schemareservationstatus)|-|**Required** Supported values: `PENDING_CONFIRMATION`, `RESERVED`, `CANCELLED`. Please note that `PENDING_CONFIRMATION` is not currently supported and reserved for future use.|
