...
`source`|`string`|-|**Required** Source of rating. Supported values: `NORTHSTAR`, `AAA_DIAMONDS`, `HOTELSTAR`, `STAR_RATING_AUSTRALIA`, `OTHER`|
...
`totalPrice`|`number`|-|**Required** Total price including taxes and fees per night|
...
|Name|Type|Format|Description|
|---|---|---|---|
`label`|[`SustainabilityProvider`](#schemasustainabilityprovider)|-|**Required** Name or label of the award/certification. Supported values: `GSTC`,`EARTH_CHECK`,`GREEN_GLOBE`,`GREEN_KEY`,`TRAVELIFE`,`GREEN_LEAF`,`LEED`,`GREEN_GROWTH_2050`,`GREEN_SEAL`,`HILTON_LIGHTSTAY`,`IHG_GREEN_ENGAGE`,`UK_EPC`,`NORDIC_SWAN`,`ACTIVITY_GREEN`,`ADVENTURE_GREEN_ALASKA`,`ECO_CERTIFICATION_MALTA`,`GLOBAL_ECOSPHERE_RETREATS`,`GREAT_GREEN_DEAL`,`SEYCHELLES_SUSTAINABLE_TOURISM`,`OTHER`|
