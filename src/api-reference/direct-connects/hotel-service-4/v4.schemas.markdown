...
`roomDescription`|`string`|-|Room description information.|
`comments`|`string`|-|Comments about special requests or preferences from the user for this booking.|
`notes`|`string`|-|Additional information from the supplier for the traveler (e.g., loyalty points, special instructions).|
