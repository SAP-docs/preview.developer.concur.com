...
|Name|Type|Format|Description|
|---|---|---|---|
`bookingId`|`string`|-|SAP Concur system id of existing booking that needs to be updated, as obtained during reservation request from [`ReservationCriteria`](#schemareservationcriteria).`bookingUuid` (Required for `oldBookings`)|
