...
`totalPrice`|[`TotalPrice`](#schematotalpricehotelproperty)|-|**Required** Details about the total pricing associated with stay.
...
|Name|Type|Format|Description|
|---|---|---|---|
`totalOverStay`|[`TotalOverStay`](#schematotalOverStay)|-|**Required** |
...
## <a id="schematotalOverStay"></a> TotalOverStay
