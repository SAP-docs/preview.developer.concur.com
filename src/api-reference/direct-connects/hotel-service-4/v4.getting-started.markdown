...
In order to enable faster certification, you can use the following testing tools that will allow custom hotel suppliers to validate the majority of functional and non-functional requirements of this API during the development phase. Please use these tools as required both during development and once development is complete and provide the test results to your SAP Concur contact via Smartsheet.
