...
## Single PNR Solution
SAP Concur is soon to launch (currently scheduled for Q2 2025) a new feature called Single PNR Solution. This will allow suppliers to work in the same PNR as GDS bookings made through SAP Concur. Please refer to [Single PNR Solution](./v4.single-pnr-solution.html) for more details.

## Hotel Modify Booking Support
If you are interested in supporting modifying existing bookings, please refer to [Hotel Modify Booking](./v4.hotel-modify-booking.html) for more details. Please note that hotel modify support is currently scheduled for Q2 2025.
