...
This feature allows suppliers to work in the same PNR as GDS bookings made through the SAP Concur platform. For detailed information, check out [Single PNR Solution](/api-reference/direct-connects/hotel-service-4/v4.single-pnr-solution.html).
