...
## Notify Cancellation <a id="opIdnotifyCancel"></a>

Notify cancellation of an active segment in a GDS sourced booking with Single PNR configured.

### URI

```shell
POST /hotels/reservation/cancel/notify
```
