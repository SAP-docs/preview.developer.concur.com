...
* We strongly recommend to use certificate Common Name as authentication mechanism. If you rely on certificate Serial Number or certificate itself, please be awar that in the beginning of each year certificate will be re-issued and you we have to update your auth mechanisms.
