...
<!-- TODO: Add any limitations specific to this API (data center availability, feature gaps, access token restrictions, etc.) -->

## <a name="process-flow"></a>Process Flow

<!-- TODO: Required by SAP. Insert a process diagram that explains the API structure and the usage flow from the user perspective for the most common use case. -->
...
<!-- TODO: List any other APIs required by the core process flow (Company Profile, User, List Item, etc.) and explain why they are required. -->

## <a name="access-token-usage"></a>Access Token Usage

<!-- TODO: List any company vs. user token differences for this API. -->
