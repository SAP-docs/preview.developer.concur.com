...
The API uses a number of data schemas for its responses and request bodies. For more details, please refer to the [API Reference](https://api.sap.com/api/ConcurExpenseSpendDocuments/overview).

## License

This API is provided unde r the [Concur Technologies Copyrights](http://www.concursolutions.com).
