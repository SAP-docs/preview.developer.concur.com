...
The values for the "message" field of the [Bulk List Item Error](#schema-bulk-list-item-error) in the [Bulk List Item Response](#schema-bulk-list-item-response):
...
Each [Bulk List Item Update Request Part](#schema-bulk-list-item-update-request-part) executes individually so a single API request can have
