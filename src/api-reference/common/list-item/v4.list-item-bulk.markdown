...
`There exists a list item in the same list category with this list item code. List item code must be unique within a category. If categories are enabled, this list item can be shared between lists.` |The list item already exists in another list with the same list category. This list item already exists in another linked list.|
