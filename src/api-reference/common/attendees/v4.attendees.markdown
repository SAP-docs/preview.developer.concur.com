...
1. The retrieval of attendee information for potential attendees to add to an expense.
...
This API requires the use of the [Identity v4](html) API to generate access tokens.
