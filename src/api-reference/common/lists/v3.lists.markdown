...
<div class="alert alert-danger">
  ...
  <p>Deprecation Date: 04/16/2021</p>
...
<div class="alert alert-danger">
  ...
  <p>Updates list specified in the URL. Only the fields provided in the supplied object will be updated, missing fields will not be altered.</p>
