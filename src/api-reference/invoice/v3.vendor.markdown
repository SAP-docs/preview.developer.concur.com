...
<div class="alert alert-danger">
  ...
  <p>Deprecation Date: 02/01/2023</p>
  <p>Decommission Date: 11/30/2023</p>
  <p>Partners and customers using a deprecated API should contact SAP Concur and move to the latest versions.</p>
...
## <a name="limitations"></a>Limitations
 ...
 Access to this documentation does not provide access to the API. This API is not available in the China data center.
