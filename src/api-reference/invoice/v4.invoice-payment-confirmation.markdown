...
![A process flow diagram of the Invoice Payment Confirmation API](./v4-invoice-payment-confirmation-process-flow.png)

<img src=./v4-invoice-payment-confirmation-process-flow.png width="500" height="400">
