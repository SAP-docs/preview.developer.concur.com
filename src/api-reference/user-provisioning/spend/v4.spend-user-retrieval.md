---
title: Spend User Retrieval v4
layout: reference
---

# Spend User Retrieval v4

<div class="alert alert-danger">
  <p><strong>This API has been deprecated.</strong></p>
  <p>Deprecation Date: 3/14/24</p>
...
```
GET https://us2.api.concursolutions.com/profile/spend/v4/Users?startIndex=1&itemsPerPage=4&filter=urn:ietf:params:scim:schemas:extension:spend:2.0:User:country eq "US"
```
