...
```
GET https://us.api.concursolutions.com/profile/v4/provisions/?&startIndex=1&itemsPerPage=4&filter=urn:ietf:params:scim:schemas:extension:spend:2.0:User:country+eq+%22US%22
```
