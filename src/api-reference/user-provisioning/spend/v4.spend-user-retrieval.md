...
* [Full Spend User](#full-spend-user-)
* [Error](#error-message-response-)
...
|`Resources`|[`FullSpendUser`](#full-spend-user-)|-|A multi-valued list of complex objects containing the requested resources.|
...
|---|:---:|:---:|---|
|`schemas`|`string`|-|The schemas present in the resource.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:User`|[`SpendUser`](v4.spend-user-extension-schema.html#spend-user-extension-)|-|The user's base spend data.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:Approver`|[`ApproverExtension`](v4.spend-user-extension-schema.html#approver-extension-)|-|The user's spend approver data.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:Delegate`|[`DelegateExtension`](v4.spend-user-extension-schema.html#delegate-extension-)|-|The user's spend delegate data.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:Role`|[`SpendRole`](v4.spend-user-extension-schema.html#spend-role-extension-)|-|The user's spend role data.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:UserPreference`|[`UserPreferenceExtension`](v4.spend-user-extension-schema.html#user-preference-extension-)|-|The user's user preference settings.|
|`urn:ietf:params:scim:schemas:extension:enterprise:2.0:Payroll`|[`ADPExtension`](v4.spend-user-extension-schema.html#adp-extension-)|-|The user's ADP data.|
|`urn:ietf:params:scim:schemas:extension:spend:2.0:WorkflowPreference`|[`WorkflowPreferenceExtension`](v4.spend-user-extension-schema.html#workflow-preferences-extension-)|-|The user's workflow preference settings.|
