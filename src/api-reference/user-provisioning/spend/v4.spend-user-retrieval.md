...
|`urn:ietf:params:scim:schemas:extension:spend:2.0:ApproverLimit`| [`ApproverLimitExtension`](./v4.spend-user-extension-schema.html#approver-limit-extension-schema) |-| The user's spend approver limit data. |
