...
```
GET https://us2.api.concursolutions.com/profile/spend/v4/Users?startIndex=1&itemsPerPage=2&filter=urn:ietf:params:scim:schemas:extension:spend:2.0:User:country+eq+%22US%22
```
