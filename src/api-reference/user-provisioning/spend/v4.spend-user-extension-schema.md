...
|`value`|`string`|-|Value of the custom field.<br> **NOTE**: For a field that's configured with either type "Connected List" or "List" under the Employee Form, please use List Item Code as the value.|
