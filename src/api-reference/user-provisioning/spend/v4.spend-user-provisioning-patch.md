...
#### Request: Remove single Approver
**NOTE:** Remove operation uses the path for removing a specific identity.
```json
{
    "schemas": [
        "urn:ietf:params:scim:api:messages:2.0:PatchOp"
...
**NOTE:** Remove operation uses the path for removing resources.
```json
{
  "schemas": [
    "urn:ietf:params:scim:api:messages:2.0:PatchOp"
