...
|`officeLocationCountry`| `string` |-|Country/Region. Valid ISO 3166 country code of office location. Length: 2 characters|
|`officeLocationStateProvince`| `string` |-|Valid ISO sub country code of office location. Example: `WA`. Length: 2 characters|
|`officeLocationCity`| `string` |-|City of office location. Example: `Redmond`|
