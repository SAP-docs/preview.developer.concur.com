...
`startDate`| `DateTime` | ISO 8601 | The startDate field (pattern = "yyyy-MM-dd") specifies the beginning date for the range of results to be included. If not provided, then the standard Java Epoch: 1970-01-01T00:00:00 is considered by default. Currently, this field isused for UAC/DDS historical hydration of users in an entity. |
`endDate`| `DateTime` | ISO 8601 | The endDate field (pattern = "yyyy-MM-dd") specifies the end date for the range of results to be included. If not provided, then the current date time is considered by default. Currently, this field isused for UAC/DDS historical hydration of users in an entity.                                        |
...
```
GET https://integration.api.concursolutions.com/profile/spend/v4.1/Users?startIndex=1&itemsPerPage=4&filter=urn:ietf:params:scim:schemas:extension:spend:2.0:User:country+eq+%22US%22
```
...
```
GET https://us.api.concursolutions.com/profile/spend/v4.1/Users/{UserId}
```
...
```
GET https://integration.api.concursolutions.com/profile/spend/v4.1/Users/94bf66c2-272c-4760-91f5-4d5290a033a8
```
#### Response
