...
|`processorReportAccess`|`string`|-| Report access for processor roles (Expense Processor, Expense Processor Audit, Expense Processor Manager). Supported values: `C` (Complete) , `R` (Restricted)|
