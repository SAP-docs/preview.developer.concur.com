...
`timezone`|`string`|-|The user's time zone in the Olson time zone database format. Default: `America/New_York` See [Time Zone Reference](/api-reference/user-provisioning/reference/timezone.html
