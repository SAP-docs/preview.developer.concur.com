...
## <a name="process-flow"></a> Provisioning Process Flow
...
## <a name="create-users-post"></a>Create a User Provisioning Request using POST with /Users endpoint

Creates one provisioning requests via the /Users endpoint. Recommended for clients who are updating single user profiles at a time. Clients are partners are able to provision identity, spend and travel profile information via this endpoint. 
...
### <a name="update-users-patch"></a>Update the Profile Data of a User using PATCH with /Users endpoint

Updates one or more user provisioning requests. 
...
### <a name="replace-users-put"></a>Replace a User Resource using PUT with /Users endpoint
...
## <a name="create-bulk-post"></a>Create a Provisioning Request for One or More Users using POST with /Bulk endpoint

Creates one or more provisioning requests via the /Bulk endpoint. Recommended for clients who are performing bulk updates to multiple users at the same time. 
...
### <a name="update-bulk-patch"></a>Update One or More Provisioning Requests using PATCH with /Bulk endpoint
...
### <a name="replace-bulk-put"></a>Replace One or More Resources using PUT with /Bulk endpoint
...
`error`|HTTP Error code| An issue with the request operation. UPS will respond with Error code and message.
