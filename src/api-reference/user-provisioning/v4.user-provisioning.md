...
For additional infomation: [User Provisioning Event](/event-topics/user-provisioning/v4.user-provisioning-events.html)

## <a name="supporting-documenation"></a>Supporting Documenation
...
* [Spend Extention Schema support](/api-reference/user-provisioning/spend/v4.spend-user-extension-schema.html)
* [Travel Extention](/api-reference/user-provisioning/travel/v4.travel-extension.html)
