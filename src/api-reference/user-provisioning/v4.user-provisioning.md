...
The User Provisioning Service (UPS) allows callers to provision and update a user’s profile including a users [roles](/api-reference/user-provisioning/spend/v4.spend-role-code-definition.html). Once a user is provisioned, the user's profile is available to support the [Identity](/api-reference/profile/v4.identity.html), [Spend](/api-reference/user-provisioning/spend/v4.spend-user-retrieval.html), and [Travel](/api-reference/user-provisioning/travel/v4.travel-extension.html) services. The service allows clients and partners to modify profiles in bulk or individually.
...
This API isavailable to clients and partners who have been granted access. Access to this documentation does not provide access to the API. This API is available in US and EMEA data centers.
...
`identity.user.sap.read`|Read a user's SAP Global ID. Used for intra SAP service communication. Contact account manager|GET
`identity.user.sap.writeonly`|Write a user's SAP Global ID. Used for intra SAP service communication. Contact account manager|POST, PUT, PATCH
...
```shell
POST https://us2.api.concursolutions.com/profile/v4/Users/
```
...
```shell
{
    "meta": {
        ...
        "version": 0,
        "location": "https://us2.api.concursolutions.com/profile/identity/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7",
        "statusUrl": "https://us2.api.concursolutions.com/profile/v4/provisions/2b41c0c1-15f7-41cc-99bb-a82b5da128a2/status",
...
```shell
PATCH https://us2.api.concursolutions.com/profile/v4/Users/<Concur UUID>
```
...
```shell
PATCH https://us2.api.concursolutions.com/profile/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7
```
...
```shell
{
    ...
    "meta": {
        ...
        "version": 3,
        "location": "https://us2.api.concursolutions.com/profile/identity/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7",
        "statusUrl": "https://us2.api.concursolutions.com/profile/v4/provisions/e820c001-c358-4a3e-964a-321dc2a76203/status",
...
```shell
PUT https://us2.api.concursolutions.com/profile/v4/Users/<Concur UUID>
```
...
```shell
PUT https://us2.api.concursolutions.com/profile/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7
```
```shell
...
```shell
{
    "meta": {
        ...
        "version": 0,
        "location": "https://us2.api.concursolutions.com/profile/identity/v4/Users/61bd5549-d68c-407b-8228-9590ae40eaa0",
        "statusUrl": "https://us2.api.concursolutions.com/profile/v4/provisions/03295e27-c9c2-4579-92d8-8b46ec91eff5/status",
...
```shell
POST https://us2.api.concursolutions.com/profile/v4/Bulk/
```
#### Parameters
...
```shell
{
    ...
    "meta": {
        "location": "https://us2.api.concursolutions.com/profile/v4/provisions/9ff00c90-1c35-4fd1-8ac7-db8b9be70a98/status",
...
```shell
PATCH https://us2.api.concursolutions.com/profile/v4/Bulk/
```
#### Parameters
...
```shell
{
    ...
    "meta": {
        "location": "https://us2.api.concursolutions.com/profile/v4/provisions/193975e3-f9b2-4786-813d-b209ee0f8527/status",
...
```shell
PUT https://us2.api.concursolutions.com/profile/v4/Bulk/
```
#### Parameters
...
```shell
{
    ...
    "meta":
        "location": "https://us2.api.concursolutions.com/profile/v4/provisions/a43fd01c-fc99-4cf1-a16e-6f440b797603/status",
...
```shell
GET https://us2.api.concursolutions.com/profile/identity/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5
GET https://us2.api.concursolutions.com/profile/spend/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5
GET https://us2.api.concursolutions.com/profile/travel/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5
```
...
```shell
GET https://us2.api.concursolutions.com/profile/identity/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7
```
...
```shell
{
    ...
    "meta": {
        ...
        "version": 16,
        "location": "https://us2.api.concursolutions.com/profile/identity/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5"
    },
    "displayName": "John",
    "name": {
        "middleInitial": "J",
...
```shell
GET https://us2.api.concursolutions.com/profile/v4/provisions/0e00f6a4-6798-4f66-9f47-1e944b619b2e/status
```
...
eb    "status": {
  ...
  "meta": {
    "location": "https://us2.api.concursolutions.com/profile/v4/provisions/0e00f6a4-6798-4f66-9f47-1e944b619b2e/status",
...
```shell
GET https://us2.api.concursolutions.com/profile/v4/provisions/{provision-id}/status?attributes=operations
```
#### Parameters
...
```shell
GET https://us2.api.concursolutions.com/profile/v4/provisions/0e00f6a4-6798-4f66-9f47-1e944b619b2e/status?attributes=operations
```
...
```shell
GET https://us2.api.concursolutions.com/profile/v4/ResourceTypes
```
...
[
    {
        ...
        "meta": {
            "location": "https://us2.api.concursolutions.com.com/profile/v4/ResourceTypes/User",
...
```shell
GET https://us2.api.concursolutions.com/profile/v4/Schemas
```
...
**NOTE:** Please refer to the [Spend Role Codes](./spend/v4.spend-role-code-definition.html) page for the available value of `roleName`.
...
Name|Type|Format|Description
---|---|---|---
|`ruleClass`|`object`|-|**Required** Defines the rule class for the travel user either ID **or** name should be provided. Value must exactly match Travel Class name maintained in Travel. ruleClass can be found under: Administration -> Travel -> Travel Admin.
