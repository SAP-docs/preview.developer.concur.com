...
## Create a Provisioning Request for One or More Users <a name="create-bulk-post"></a>
...
## Create a User Provisioning Request <a name="create-users-post"></a>
...
## Retrieve User Profile Data <a name="#get-user"></a>

To retrieve profile data for a specific user, the SAP Concur platform has enabled separate endpoints. For additional information for provisioning the specific profiles, please see the documentation for [Identity](/api-reference/profile/v4.identity.html), [Spend](/api-reference/user-provisioning/spend/v4.spend-user-get-started.html), and [Travel](/api-reference/user-provisioning/travel/v4.travel-extension.html).
...
## Retrieve a Summary Provisioning Request Status <a name="retrieve-summary-provision-request-status"></a>
...
```
## Retrieve a Detailed Provisioning Request Status <a name="retrieve-detailed-provision-request-status"></a>
...
## Retrieve Supported Resource Types <a name="retrieve-resource-types"></a>
...
## Retrieve Supported Schemas <a name="retrieve-schemas"></a>
...
`name`|`complex`|-|User's Travel Name (as distinct from HR Name). This must match user's travel documents.
