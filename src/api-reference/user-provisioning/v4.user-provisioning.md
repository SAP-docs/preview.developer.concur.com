...
`identity.user.sap.writeonly`|Read a user's SAP Global ID. Used for intra SAP service communication. Contact account manager|GET
`identity.user.sap.read`|Write a user's SAP Global ID. Used for intra SAP service communication. Contact account manager|POST, PUT, PATCH
