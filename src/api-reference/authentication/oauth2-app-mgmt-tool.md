...
`App Stage`|	Drop-down list|	Y |Specify the current phase of the App - Development or Test or Production. NOTE: If the app is re-used for subsequent phases, ensure to update the stage as applicable.
