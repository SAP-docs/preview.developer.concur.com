...
---|---|---|---
`docType`|`string`|`path`|**Required** The financial document type to return. Only one type of transaction can be retrieved at a time. Supported values are: `expense`, `invoice`, `cashadvance`, `payroll`, `requestobligation`.
...
Name|Type|Format|Description
---|---|---|---
`docType`|`string`|`path`|**Required** The financial document type to return. Only one type of transaction can be retrieved at a time. Currently supported: `expense`,`invoice` Future release:           `cashadvance`, `payroll`, `requestobligation`
`confirmationRequest`||[body](#confirmationrequest)|**Required** The JSON request to be posted.
...
#### Payload
##### Please refer payload format for relevant docType from below:

[Payment Confirmation Request (expense docType)](#schema-paymentrequest-expense)  
[Payment Confirmation Request (invoice docType)](#schema-paymentrequest-invoice)
...
### <a name="schema-paymentrequest-expense"></a>Payment Confirmation Request (Expense)

Name|Type|Format|Description
---|---|---|---
`systemId`|`string`|-|**Required** The external system ID that acknowledged the documents, it can be an empty string. Maximum 50 characters.
`processingConfirmation`|`Array`|[Payment Confirmation Request Item](#schema-paymentconfirmationrequest-expense)|Payment confirmations JSON request.

### <a name="schema-paymentconfirmationrequest-expense"></a>Payment Confirmation Request Item (Expense)
...
`clearingDetails`|`array`|[Payment Documents Details](#schema-paymentdocs-expense)|Payment documents details, if any.

### <a name="schema-paymentdocs-expense"></a>Payment Documents Details (Expense)
...
`receiver`|`array`|[Receiver Details](#schema-receiver-expense)|Receiver details.
`clearingReference`|`array`|[Clearing Reference Details](#schema-clearing-reference-expense)|Clearing reference details.

### <a name="schema-receiver-expense"></a>Receiver Details (Expense)
...
### <a name="schema-clearing-reference-expense"></a>Clearing Reference Details (Expense)
...
### <a name="schema-paymentrequest-invoice"></a>Payment Confirmation Request (Invoice)

Name|Type|Format|Description
---|---|---|---
`systemId`|`string`|-|**Required** The external system ID that acknowledged the documents, it can be an empty string. Maximum 50 characters.
`processingConfirmation`|`Array`|[Payment Confirmation Request Item](#schema-paymentconfirmationrequest-invoice)|Payment confirmations JSON request.

### <a name="schema-paymentconfirmationrequest-invoice"></a>Payment Confirmation Request Item (Invoice)

Name|Type|Format|Description
---|---|---|---
`docId`|`string`|-|The financial document ID to confirm. Maximum 32 characters.  
`invoiceAmount`|`double`|-|Invoice amount.  
`paymentStatus`|`string`|-|Payment status. Supported values: PAID, VOID, CANCEL  
`paymentStatusDate`|`string`|`YYYY-MM-DD`|Payment date.  
`checkNumbers`|`array`|-|Check numbers.  
`paymentMethodType`|`string`|-|Pay method type.  
`paymentAmount`|`double`|-|Payment amount.  
`notesToSupplier`|`string`|-|Notes to supplier, if any.  
`paymentAdjNotes`|`string`|-|Payment adjustment notes, if any.  
