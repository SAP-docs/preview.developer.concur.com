...
After the request has been submitted, during the Funds Reservation Step in the workflow, an Obligation Payload with instruction "obligate" is made available to financial system via FIS API.
