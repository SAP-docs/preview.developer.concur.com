...
During the second Funds Reservation workflow step, Request Obligation Payload with instruction "obligate" is made available to the financial system via FIS API 
...
During the Funds Check workflow step, Request Obligation Payload with instruction "fundsCheck" is made available to the financial system via FIS API.
