...
#### Simple Funds Reservation 
#### Funds Reservation on Request 


##### Description
   When the Request is created and FGI is enabled for a Group that an employee belongs to, during the workflow, when the Funds Reservation step is reached, the workflow is paused, an event ___ is published and a Request Obligation document is made available to financial system.

##### Example:
•	The Request with one or more Funds Reservation in the Request workflow, linked to one or more Reports. 
Travel Request with one expense item: Air Fare – USD 1200
...
[**Request Obligation JSON Payload**](json/FI-FundsReservation-RequestID-5175B347418EEB489B900D2D8E065E10-Example-1.0.json)

#### Funds Reservation in the Financial System:
Once the Request Obligation Payload is received, the financial system sends acknowledgement back to Concur.

[**Sample Acknowledgement Payload**](json/FI-FundsReservation-Ack-46900c4966b14bad9b968a84c0388124-Example-1.0.json)
...
[**Sample Confirmation Payload**](json/FI-FundsReservation-Cnf-57e4d6c30f2c4d5bbd4ac7adc8bc8233-Example-1.0.json)
...
•	A Request Release Payload is made available to the financial system and the event ___ is published

[**JSON Payload**](json/FI-FundsReservation-ReleaseID-5DDF93D4CB036144B7918B12187AEB42-Example-1.0.json)
