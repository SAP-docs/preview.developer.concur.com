...
---------------------|-----------|--------|----------------------------------------------------------------------------------------------------------
 ...
 `hasNoLodging`      | `boolean` | -      | Traveller indicates that the itinerary has no overnight stays, e.g. a truck driver is driving overnight. 
...
-------------|----------|----------------------------------------------|--------------------------------------------------------------------------------------------
 ...
 `period`    | `object` | [`ItineraryPeriod`](#schema-itineraryperiod) | Period of time in which an itinerary is assigned to a context id. 
