...
This endpoint creates an itinerary for a specific a user. 
...
---|---|---|---
`userId` | `string` | uuid   | **Required** Unique identifier of a traveler(user).
`companyId`| `string`| uuid  | Unique identifier of a companyy.
`body` | `object`| [Body Schema](#schema-itinerary) | **Required** Itinerary body to be created.
