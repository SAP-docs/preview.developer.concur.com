...
Concur's Travel Allowance Service provides an automated solution for managing employee travel expenses. It streamlines
...
Version 4.0 of Travel Allowance API works only with the
new [Authentication API](/api-reference/authentication/apidoc.html).

## <a name="overview"></a>Overview

The Travel Allowance v4 API exposes three different resources:
