...
`userId`|`string`|-|The unique identifier of the user getting the participant list. If empty when using a Company token the default system user will be assumed to perform the action.
