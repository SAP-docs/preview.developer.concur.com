...
## Expected Expense Resources <a name="expected-expense-resource"></a>
...
## Create a new expected expense <a name="create-new-expected-expense-resource"></a>
...
## Get the list of expected expenses attached to a Request <a name="get-expected-expense-attached-request-resource"></a>
...
## Get the content of an expected expense <a name="get-content-expected-expense-resource"></a>
...
## Update the content of an expected expense <a name="update-content-expected-expense-resource"></a>
...
## Delete an expected expense from the Request <a name="delete-expected-expense-request-resource"></a>
...
## Get the list of comments for an existing expected expense <a name="expected-expense-resource-comments"></a>
