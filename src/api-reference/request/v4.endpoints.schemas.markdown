...
`allowParticipants`|`boolean`|-|Whether this policy can add participants.
...
`requests`|`array`|[`ResourceLink`](#schema-resourcelink)|Child requests from participant associated with the parent request.
