...
`classListItemId`|`string`|-|The unique identifier of the class of service of the air segment (will populate the "Class" list field of the air segment form - if displayed).
...
`classListItemId`|`string`|-|The unique identifier of the class of service of the rail segment (will populate the "Class" list field of the rail segment form - if displayed).
...
`classListItemId`|`string`|-|The unique identifier of the class of service of the car segment (will populate the "Class" list field of the car segment form - if displayed).
