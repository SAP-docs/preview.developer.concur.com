...
| `currency` | `string` | ISO 4217 | Currency used to express amounts (According to the ISO 4217 codes).| Yes | - |
| `exchangeRate` | `number` | - | Exchange Rate according to currency used. | - | Yes |
