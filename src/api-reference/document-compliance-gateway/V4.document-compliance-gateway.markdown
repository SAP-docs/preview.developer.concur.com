...
* **[digitalTaxDocument](#schema-DigitalTaxToken)** - A digitalTaxDocument file in JSON format that is **required**.
...
### <a name="schema-DigitalTaxToken"></a>DigitalTaxDocument Schema
