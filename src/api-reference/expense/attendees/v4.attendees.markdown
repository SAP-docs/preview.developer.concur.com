...
--header 'Concur-CorrelationId: ac725d74-e65e-402e-a993-512b75e04044' \
...
--header 'Authorization: Bearer {access_token}' \
--header 'Concur-CorrelationId: 3ed24e8b-7fbc-4536-897a-62450e3d5ded \
--header 'Content-Type: application/json'
```
...
|Name|Type|Format|Description|
|---|---|---|---|
|`id`     |`string`|-     |**Required** The attendee ID(s). This may be a list of up to 10 comma-separated attendee ID's.|
|`userId` |`string`|`uuid`|The unique identifier of the SAP Concur user that owns the attendee. Use [Identity v4 API](/api-reference/profile/v4.identity.html)  to retrieve the `userId`. The user who is performing this API request must have the Web Services Admin (Professional) or Can Administer (Standard) user role to use this parameter.|
...
--header 'Authorization: Bearer {access_token}' \
--header 'Concur-CorrelationId: e673b813-9fa1-4007-aa3f-e58821acf61c' \
--header 'Content-Type: application/json'
```
...
--header 'Authorization: Bearer {access_token}' \
--header 'Concur-CorrelationId: d283d3d9-0bfe-4ebc-b515-a4d33e8dbde2' \
--header 'Content-Type: application/json',
--data-raw '{
    "attendeeTypeCode": "BUSGUEST",
    "firstName": "Olive",
...
`hasExceptionsPrevYear`   |`boolean`|`true / false`                        |Determines whether the attendee had exceptions in the previous year, based on yearly total limits for attendees.
`hasExceptionsYtd`        |`boolean`|`true / false`                        |Determines whether the attendee has exceptions in the current year, based on yearly total limits for attendees.
`id`                      |`string` |`uuid`                                |The unique identifier of the resource. **Note: This ID is unique to v4 API and not cross-compatible with v3**
...
`ownerName`               |`string` |`lastName, firstName`                 |The name of the user who owns the attendee record.
...
Name|Type|Format|Description
|---|---|---|---|
`attendeeTypeCode`        |`string`|-       |**Required** A code that indicates the type of attendee. An attendee's type cannot be updated. Examples: EMPLOYEE, SPOUSE, BUSGUEST. Maximum length: 8 characters
`company`                 |`string`|-       |The name of the attendee's company. Maximum length: 150 characters
