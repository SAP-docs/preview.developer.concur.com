...
`id`                      |`string` |`uuid`                                |**Required** The unique identifier of the attendee. **Note: This ID is unique to v4 API and not cross-compatible with v3**
...
`uri`                     |`string` |-                                     |**Required** The URI to the attendee.
