...
<div class="alert alert-danger">
  ...
  <p>Deprecation Date: June 26, 2025</p>
  <p>Partners and customers using a deprecated API should contact SAP Concur and discuss moving to the latest versions.</p>
  <p>This API has been replaced by <a href="https://hub.sap.com/api/ConcurExpenseExpenseReportService/overview">Expense Report Service</a>.</p>
