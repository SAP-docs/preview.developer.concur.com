...
This endpoint retrieves all cost objects for a report that the calling approver is able to approve and/or that one of his delegators is able to approve.
