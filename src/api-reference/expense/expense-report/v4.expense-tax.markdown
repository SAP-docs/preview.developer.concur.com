...
## Retrieves Tax Details for a Specified Expense on a specific Report ID <a name="tax-details-for-a-specific-expense"></a>

Gets tax details for the specified expense on a specific report ID.
