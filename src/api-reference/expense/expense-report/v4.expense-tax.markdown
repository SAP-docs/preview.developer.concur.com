...
```shell
/expensereports/v4/reports/{reportId}/expenses/{expenseId}/tax
```
...
```shell
curl -X 'GET' \
  'https://us.api.concursolutions.com/expensereports/v4/reports/28BA437223EE41A49F7B/expenses/51ADA86C8EB164488FE67180CCE16EDB/tax' \
