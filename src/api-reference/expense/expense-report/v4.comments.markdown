...
* [200 OK](https://datatracker.ietf.org/doc/html/rfc7231#section-6.3.2)
...
* [Comment Save Request](#comment-save-request-schema)
...
* [Comment URI Response](#comment-uri-response-schema)
...
* [Comment URI Response](#comment-uri-response)
...
### <a name="comment-save-request-schema"></a> Comment Save Request
|Name|Type|Format|Description|
|---|---|---|---|
|`comment`|`string`|-|The comment to be saved.|


### <a name="comment-uri-response-schema"></a> Comment URI Response
|Name|Type|Format|Description|
|---|---|---|---|
