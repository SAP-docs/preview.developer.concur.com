...
```
## <a name="post-report-header-comments"></a>Post Report Header Comments
...
* [Report Header Comment Save Request](#report-header-comment-save-request-schema)
...
* [Report Header Comment URI Response](#report-header-comment-uri-response-schema)
...
`expense.report.delete` - Refer to [Scope Usage](#scope-usage) for full details.
...
### <a name="report-header-comment-save-request-schema"></a>Report Header Comment Save Request
|Name|Type|Format|Description|
|---|---|---|---|
|`comment`|`string`|-|The comment to be saved.|


### <a name="report-header-comment-uri-response-schema"></a> Report Header Comment URI Response
|Name|Type|Format|Description|
|---|---|---|---|
|`uri`|`string`|-|A URI of the specified comment.|
