...
`Custom1 through Custom20`|`CustomField`|-|The details from the Custom fields. These fields may not contain data unless they are explicitly added to the report form configuration.
...
`OrgUnit1 through OrgUnit6`|`CustomField`|-|The details from the Org Unit fields. These fields may not contain data unless they are explicitly added to the report form configuration.
