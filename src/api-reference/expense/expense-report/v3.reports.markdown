...
`Custom1 thorugh Custom20`|`CustomField`|-|The details from the Custom fields. These fields may not contain data unless they are explicitly added to the report form configuration.
