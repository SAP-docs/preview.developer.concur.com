...
* The Approve function advances the specified report to the next step (use short URL Approve API if it is in a system step). 
...
curl --location --request PATCH 'https://us.api.concursolutions.com/expensereports/v4/users/32C2FCC3-B2E8-4907-9672-5B3F49B1C643/context/TRAVELER/reports/764428DD6A664AF0BFCB/approve' \
--header 'Authorization: Bearer {access_token}' 
--header 'Content-Type: application/json'
--data-raw '{
"comment":"Approved",
