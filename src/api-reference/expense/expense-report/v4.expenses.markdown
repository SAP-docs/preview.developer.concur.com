...

{
    ...
    "invoiceId": "05251E70F66FF742A29FC172BE728272",
    "governmentInvoiceId": "05251E70F66FF742A29FC172BE728272"
}
```
...
| `invoiceId`                       | `string`                                                         | -                      | The supplier invoice id for the expense.                                                                                                                                                                                                                                                                                                                                                     |
| `governmentInvoiceId`             | `string`                                                         | -                      | The government invoice id for the expense.                                                                                                                                                                                                                                                                                                                                                     |
