...
[Budget Item Save Response](#budgetItemHeaderSaveResponse) or [Error Response](#errorResponse)
...
{
  "success": true,
  "budgetItemHeaderSyncGuid": "6f5c0189-f680-407b-b474-df917151a947",
  "budgetItemDetailSyncGuids": [
    "29e46a1e-ea18-43ef-80b1-4c311cdf0fe7"
  ]
}
```
...
## DELETE a Budget Item Header <a name="delete"></a>
...
### <a name="budgetItemHeaderSaveResponse"></a>BudgetItemHeaderSaveResponse

Name|Type|Format|Description
---|---|---|---
`success`|`boolean`|-|`True` or `False` for success or failure.
`budgetItemHeaderSyncGuid`|`guid`|-|The key of the created/updated budget item header.
`budgetItemDetailSyncGuids`|`array` of `guid`|-|The keys of the created/updated budget item details.
