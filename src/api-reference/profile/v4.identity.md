...
`name.nickName`|`string`|-|The casual way to address the user. This attribute should not be used to represent a user's username. Displays as Preferred Name in UI. 
...
`manager`|`object`|-|The manager of this user. To update manager, must include both employeeNumber and value.
