...
```
GET https://us2.api.concursolutions.com/profile/identity/v4/Users/{UUID}
```
...
```
GET https://us2.api.concursolutions.com/profile/identity/v4/Users/3df11695-e8bb-40ff-8e98-c85913ab2789
Accept: application/json
Authorization: BEARER {token}
```
...
```
GET https://us.api.concursolutions.com/profile/v4/ServiceProviderConfig/
```
##### Parameters
...
|Name|Type|Format|Description|
|---|---|---|---|
`attributes`|[`Schema Extension`](#schemaschemaextension)|-|**Required** The resource's extensions.
...
`mutability`|`string`|-|A single keyword indicating the circumstances under which the value of the attribute can be (re)defined.
`maxLength`|`integer`|-|The maximum length of the returned value. 
`pid`|`integer`|-|"WHAT IS A PID" *********************************
