...
---|---|---|---
`creditCardGuid`|`string`|-|Credit card GUID - Its a token which represent credit card number in concur expense. This creditCardGuid can be obtained from cardAccountID field from FIS.
