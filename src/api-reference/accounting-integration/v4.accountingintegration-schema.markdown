...
`isDeleted`|`boolean`|-|**PATCH method** Flag to show if this record needs to be deleted

### <a name="account-type"></a>AccountType
Name|Type
---|---
ACCOUNTS\_PAYABLE|`string`
ACCOUNTS\_RECEIVABLE|`string`
BANK|`string`
COST\_OF\_GOODS\_SOLD|`string`
CREDIT\_CARD|`string`
DEPRECIATION|`string`
EQUITY|`string`
EXPENSE|`string`
FIXED\_ASSETS|`string`
FUTURE\_ASSETS|`string`
INCOME|`string`
LOAN|`string`
LONG\_TERM\_LIABILITIES|`string`
OTHER\_ASSETS|`string`
OTHER\_CURRENT\_ASSETS|`string`
OTHER\_CURRENT\_LIABILITIES|`string`
OTHER\_EXPENSE|`string`
OTHER\_INCOME|`string`
...
Name|Type|Format|Description
---|---|---|---
`partnerAppName`|`string`|-|**Required** Name of the Partner App to be shown on Concur UI
`erpName`|`string`|-|**Required** The ERP name
`realmId`|`string`|-|**Required** Realm ID is a unique identifier of the company in the ERP
`features`|`array`|[`ErpFeatureFlag`](#erp-feature-flag)|Feature capabilities of the ERP integration
`erpId`|`string`|`UUID`|**Response only** Universally unique identifier of the ERP integration in Concur
...
Name|Type|Format|Description
---|---|---|---
`formTypeCode`|`string`|-|Form type code to match with the Financial Information document
...
`listMappings`|`array`|[`ListMapping`](#list-mapping)|List of ERP list to Concur list mappings
...
`links`|`array`|[`Links`](#links)|**GET method** The array of hrefs to retrieve the next page
`deleteAll`|`boolean`|-|**PATCH method** If `deleteAll` flag is true, delete all data for the given object type before processing the new data.

### <a name="list-of-list"></a>List of ERP List Names
Name|Type|Format|Description
---|---|---|---
`data`|`array`|[`List`](#erp-list)|List of ERP List Names
`links`|`array`|[`Links`](#links)|**GET method** The array of hrefs to retrieve the next page
`deleteAll`|`boolean`|-|**PATCH method** If `deleteAll` flag is true, delete all data for the given object type before processing the new data.
...
`links`|`string`|[`Links`](#links)|The array of hrefs to retrieve the next page

### <a name="list-mapping"></a>ListMapping
Name|Type|Format|Description
---|---|---|---
`erpListId`|`string`|-|Unqiue identifier of the ERP list
`concurListId`|`string`|-|Unqiue identifier of the Concur list
`fieldMappings`|`array`|[`FieldMapping`](#field-mapping)|List of Concur form and fields where the ERP list is used
...
`links`|`array`|[`Links`](#links)|The array of hrefs to get the error details or processing status

### <a name="mappings-response"></a>MappingsResponse
Name|Type|Format|Description
---|---|---|---
`erpId`|`string`|`UUID`|Universally unique identifier of the ERP in Concur
`features`|`array`|[`Feature`](#feature)|List of Features that the company will use
`files`|`array`|[`FileMapping`](#file-mapping)|List of the settings and mappings for each ERP file that the company uses. Could be a single entry if the company does not use files in the ERP
...
Name|Type|Format|Description
---|---|---|---
`companyId`|`string`|`UUID`|Universally unique identifier of the company in Concur
`requestId`|`string`|`UUID`|Unique identifier of the request in UUID format
...
`transactionType`|`string`|-|Transaction type - Bill or Credit
