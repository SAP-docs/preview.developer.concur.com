...
* Request: [List of ERP List](./v4.accountingintegration-schema.markdown#list-of-list)
...
* Request: None
* Response: [List of ERP List](./v4.accountingintegration-schema.markdown#list-of-list), [Error](./v4.accountingintegration-schema.markdown#schema-error)
