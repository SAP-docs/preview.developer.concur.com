...
* Request: [List of Account](./v4.accountingintegration-schema.markdown#list-of-account)
* Response: [RequestStatus](./v4.accountingintegration-schema.markdown#request-status), [Error](./v4.accountingintegration-schema.markdown#schema-error)
...
* Request: None
* Response: [List of Account](./v4.accountingintegration-schema.markdown#list-of-account), [Error](./v4.accountingintegration-schema.markdown#schema-error)
