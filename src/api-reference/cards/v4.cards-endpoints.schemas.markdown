...
---|---|---|---
`accounts`|`array`|[`Create Account`](#schema-create-account)|An array of Accounts to be created. (Maximum number of accounts per call: 1000)
...
Name|Type|Format|Description
---|---|---|---
`transactions`|`array`|[`Create Transaction`](#schema-create-transaction)|**Required** An array of transactions to be created. (Maximum number of transactions per call: 1000)
