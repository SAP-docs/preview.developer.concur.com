...
Name|Type|Format|Description
---|---|---|---
`errorCode`|`string`|-|**Required** Machine readable code associated with the error which is static and never localized. Possible error codes see [Cards v4 - Error Codes](./v4.cards-error-codes.html)
`errorMessage`|`string`|-|**Required** Message associated with the error
`dataPath`|`string`|-|Relative data path
...
## <a name="error-codes"></a>Detailed Error Codes
