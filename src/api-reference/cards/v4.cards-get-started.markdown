...
---|---|---
Account|Partners can create Accounts via bulk API.|POST
Transaction|Partners can create Transactions via bulk API.|POST, GET
Bulk Request|Partners can retrieve the details of a Bulk Request.|GET
