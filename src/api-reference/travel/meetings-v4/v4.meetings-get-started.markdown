...
The Meetings API lets you create and manage meetings and their attendees within Concur Travel. It supports two primary use cases: meetings created natively within the SAP Concur platform using the Meetings Admin UI or Joule, and meetings created by external partners through API integration.
...
SAP Concur clients must purchase Concur Travel in order to use this API. Please contact your SAP Concur representative for more information.

Partner applications must be registered on App Center with the `meetings.read` and/or `meetings.write` scopes approved. Contact your SAP Concur representative for more information.
