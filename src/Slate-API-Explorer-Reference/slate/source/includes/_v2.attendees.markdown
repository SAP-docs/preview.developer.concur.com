...
---|---|---
attendeeID|optional|Path: The unique identifier for the attendee in Concur. This information is returned in the **AttendeeID** element of the response of the [Get Report Details](#expense-report-get) function.
externalid|optional|Query: The unique identifier for the attendee outside of Concur. This information is returned in the **ExternalID** element of the response of the [Get Report Details](#expense-report-get) function. Up to 10 external IDs can be supplied in a comma separated list.
