...
[Receipts v4](#get-started-receipts-v4) which replaces this API opens doors to global availability, enriched schemas, and better support for detailed tax content.
