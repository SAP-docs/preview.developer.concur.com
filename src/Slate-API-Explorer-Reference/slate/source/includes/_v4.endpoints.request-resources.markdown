...
* [Get the list of existing Requests](#request-resources-get-the-list-of-existing-requests)
* [Get the content of an existing Request](#request-resources-get-the-content-of-an-existing-request)
* [Update the content of an existing Request](#request-resources-update-the-content-of-an-existing-request)
* [Delete an existing Request](#request-resources-delete-an-existing-request)
* [Get the list of comments for an existing Request](#request-resources-get-the-list-of-comments-for-an-existing-request)
* [Get the list of cash advances assigned to an existing Request](#request-resources-get-the-list-of-cash-advances-assigned-to-an-existing-request)
* [Get the list of exceptions linked to an existing Request](#request-resources-get-the-list-of-exceptions-linked-to-an-existing-request)
...
### <a name="request-resource-getlist"></a>Request Resources - Get the list of existing Requests
...
### <a name="request-resource-get"></a>Request Resources - Get the content of an existing Request
...
### <a name="request-resource-update"></a>Request Resources - Update the content of an existing Request
...
### <a name="request-resource-delete"></a>Request Resources - Delete an existing Request
...
### <a name="request-resource-comments"></a>Request Resources - Get the list of comments for an existing Request
...
### <a name="request-resource-cashadvances"></a>Request Resources - Get the list of cash advances assigned to an existing Request
...
[ResourceLink](#schema-resourcelink) - The resource link leading to the created cash advance.
...
### <a name="request-resource-exceptions"></a>Request Resources - Get the list of exceptions linked to an existing Request
