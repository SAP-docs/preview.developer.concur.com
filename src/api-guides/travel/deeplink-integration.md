...
|---|----------------------------------------------------------------------------|--------------------------------------------------------------------------------|-----------------|
|1. |Single-Sign On (SSO) not working                                            | -                                                                              |Remove the query parameter [`companyuuid`](/api-guides/travel/deeplink-integration.html#single-sign-on) and it's value from your deeplink and set instead the query parameter `username`. As value use the SSO code of the company, to which the user belongs. The Concur internal SSO code ID for a company can be received by Concur Support from the Profile. <ul><li> URI Template: <br> `https://www.concursolutions.com{path}?username={username}` </li><li> General Example of Usage: <br> `https://www.concursolutions.com?username=11A1AA` </li><li> Example of Usage including Deeplink Path and Additional Query Parameters: <br> `https://www.concursolutions.com/goto/air-shop?username=11A1AA&departurelocation=POA&departuredate=2025-02-04&returnlocation=SDU`</li></ul>|
...
|4.a.| Invalid search dates                                                      |<ul><li> *"Sorry, the dates included in the request are in the past"* </li><li> *"Sorry, your start date is after your end date"* </li><li> *"Sorry, your hotel check-in and check-out dates cannot be the same date"* </li></ul>                                                                                           |Double check the dates in your deeplink. They should be in the future, the start date should be before or the same as the end date, and in case of a hotel deeplink the start and end date need to be different from each other.|
