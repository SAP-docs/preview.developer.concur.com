...
7. CPM on duty conducts the **Development App** certification walkthrough on the scheduled date. If parnter fails in the **Development App** certification walkthrough, partner needs to fix the issues and goes back to step 6 to schedule next certification walkthrough.
...
13. CPM on duty conducts the **Production App** certification walkthrough on the scheduled date. If parnter fails in the **Production App** certification walkthrough, partner needs to fix the issues and goes back to step 12 to schedule next certification walkthrough.
