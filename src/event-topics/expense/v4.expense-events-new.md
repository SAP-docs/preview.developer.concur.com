...
The `reportUpdated` event is published when a value in the expense report header is updated. This event is not published for the workflow status changes of the report.
