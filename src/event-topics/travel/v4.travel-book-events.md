...
The topic `public.concur.travel.book` contains events for air and hotel bookings at the moment they are completed or updated.
...
`eventType`    |`string`|-                                             |Identifies the booking event type. Supported values: `travelBookingCompleted`, `travelBookingUpdated`.
...
`type`             |`string` |-                                               |Type of the event. Supported values: `concur.travel.trip.Booking.Completed.v1`, `concur.travel.trip.Booking.Updated.v1`.
